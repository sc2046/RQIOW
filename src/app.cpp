...
{
    // Load shader module.
    mComputeShader = createShaderModule(mDevice, fs::path("shaders/rqiow.spv"));
    ...
    const VkPushConstantRange pushConstantRange{ VK_SHADER_STAGE_COMPUTE_BIT, 0, sizeof(Camera) + 2*sizeof(uint) };
